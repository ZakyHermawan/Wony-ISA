...
; RUN: opt -mtriple=wony -passes=wony-simple-cst-prop %s -S -o - | FileCheck %s
; RUN: opt -mtriple=wony -wony-simple-cst-prop --bugpoint-enable-legacy-pm %s -S -o - | FileCheck %s
