...
; RUN: opt -mtriple=wony--darwin -passes=wony-simple-cst-prop %s -S -o - | FileCheck %s
; RUN: opt -mtriple=wony--darwin -wony-simple-cst-prop --bugpoint-enable-legacy-pm %s -S -o - | FileCheck %s
