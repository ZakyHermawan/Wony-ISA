...
; RUN: llc -fast-isel=0 -wony-lower-mul-mode=0 -o - %s | FileCheck %s

; Check the lowering with custom legalization of mul.
; RUN: llc -fast-isel=0 -wony-lower-mul-mode=1 -o - %s | FileCheck %s

; Check the lowering with custom dag combine for mul.
; RUN: llc -fast-isel=0 -wony-lower-mul-mode=2 -o - %s | FileCheck %s
