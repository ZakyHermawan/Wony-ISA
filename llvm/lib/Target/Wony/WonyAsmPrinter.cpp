...
// of machine-dependent LLVM code to the Wony assembly language.
//
//===----------------------------------------------------------------------===//
...
public:
  ...
  StringRef getPassName() const override { return "Wony Assembly Printer"; }
...
void WonyAsmPrinter::emitInstruction(const MachineInstr *MI) {
  // This function is autogenerated as part of the InstrInfo TableGen backend.
  Wony_MC::verifyInstructionPredicates(MI->getOpcode(),
...
// Register the AsmPrinter in the Wony target for other tools to find
// it (like Clang.)
extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeWonyAsmPrinter() {
  RegisterAsmPrinter<WonyAsmPrinter> Tmp(getTheWonyTarget());
}
