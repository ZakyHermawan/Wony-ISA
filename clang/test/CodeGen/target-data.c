...
// RUN: %clang_cc1 -triple wony-unknown -o - -emit-llvm %s | \
// RUN: FileCheck %s -check-prefix=Wony
// Wony: target datalayout = "e-p:16:16:16-n16:32-i32:32:32-i16:16:16-i1:8:8-f32:32:32-v32:32:32"
